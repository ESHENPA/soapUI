...
class BatgetAllinfo():
    def __init__(self):
        ...
        self.soapPGList1718x = ["10.14.59.11:8080", "127.0.0.1:10007", "127.0.0.1:10008"]
        self.soapPGList1519x = ["10.214.116.53:8080", "10.214.116.55:8080", "10.214.117.51:8080"]
        self.MSISDNfile = "MSISDN.txt"
        self.localfile = "numlist.txt"
        self.searchResultfile = "D:/java/python_scripts/PythonSpyder/soaouipy3/batsearchresulte/"+str(input("请输入查询结果存储文件名.csv："))
        print("正在查询请耐心等待......")
    # 生成MSISDN列表
    ...
    def getSubscriberAllInf(self):
        # 打开查询结果CSV文件，等待写入
        openfile = open(self.searchResultfile, "w",newline="")
